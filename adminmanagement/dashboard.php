...
$storage="select table_schema, sum((data_length+index_length)/1024/1024) AS MB from information_schema.tables WHERE table_schema='project'";
...
<div class="wrapper ">
    ...
    <div class="main-panel">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card card-chart">
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">access_time</i> time connect koar lagbe
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card card-chart">
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">access_time</i> total hit kaj kora lagbe
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card card-chart">
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    <i class="material-icons">access_time</i> total  kaj kora lagbe
                                    <i class="material-icons">access_time</i> total  kaj kora lagbe
                                </div>
                            </div>
                        </div>
        ...
        <div class="yourInfo container bg-info" id="profile">
